		...
		<>
			<div className="my-10 flex flex-col items-center justify-center">
				...
				<a
					...
					className="bg-slate-500 text-white text-center font-medium rounded-2xl p-3 hover:bg-slate-400 transition-color duration-200 transform hover:scale-110"
				>
					<div className="p-1">Cardápio de Exemplo</div>
					<img width={200} height={200} src="/images/qrcode-padoca-veronese.png" alt="" />
				</a>
			</div>
		</>
	)
